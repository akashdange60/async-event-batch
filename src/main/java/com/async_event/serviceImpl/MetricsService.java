...
/*	    
 ...
 //This will provide csv file with total application metrics 
	    ...
	    public Map<String, Object> collectMetrics() {
	        ...
	        metrics.put("jvm.threads.daemon",
	                meterRegistry.get("jvm.threads.daemon").gauge().value());
	        metrics.put("jvm.threads.peak",
	                meterRegistry.get("jvm.threads.peak").gauge().value());

	        // JVM Threads (MXBean – VERY IMPORTANT)
	        metrics.put("threads.total.started",
	                threadMXBean.getTotalStartedThreadCount());
	        metrics.put("threads.current",
	                threadMXBean.getThreadCount());
	        metrics.put("threads.peak",
	                threadMXBean.getPeakThreadCount());
	        metrics.put("threads.daemon",
	                threadMXBean.getDaemonThreadCount());

	        // CPU
	        metrics.put("system.cpu.usage",
	                meterRegistry.get("system.cpu.usage").gauge().value());
	        metrics.put("process.cpu.usage",
